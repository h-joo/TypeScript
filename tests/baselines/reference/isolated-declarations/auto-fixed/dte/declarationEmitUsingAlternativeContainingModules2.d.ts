...
src/index.mts(29,31): error TS2304: Cannot find name 'b'.
src/index.mts(29,31): error TS4025: Exported variable 'useEntries' has or is using private name 'b'.
...
!!! error TS2304: Cannot find name 'b'.
                                  ~
!!! error TS4025: Exported variable 'useEntries' has or is using private name 'b'.
      return useQuery({
        queryKey: entryKeys.list(),
        queryFn: testApi.getEntries,
        select: (data) => data.slice(0, 10)
