...
declare function g(addUndefined: invalid, addDefined: number): invalid;
declare let total: invalid;
declare function foo1(x: invalid, b: number): invalid;
declare function foo2(x: invalid, b: number): invalid;
...
==== defaultParameterAddsUndefinedWithStrictNullChecks.ts (14 errors) ====
    function f(addUndefined1 = "J", addUndefined2?: number) {
             ~
